...
_magic_number = 5
_modified_time = 1263403987.2825961
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 322
    ns = runtime.Namespace('__anon_0x3971f90', context._clean_inheritance_tokens(), templateuri=u'history_common.mako', callables=None, calling_uri=_template_uri, module=None)
    context.namespaces[(__name__, '__anon_0x3971f90')] = ns

    # SOURCE LINE 321
    ns = runtime.Namespace('__anon_0x3971e50', context._clean_inheritance_tokens(), templateuri=u'../tagging_common.mako', callables=None, calling_uri=_template_uri, module=None)
    context.namespaces[(__name__, '__anon_0x3971e50')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x3971f90')._populate(_import_ns, [u'render_dataset'])
        _mako_get_namespace(context, '__anon_0x3971e50')._populate(_import_ns, [u'render_tagging_element'])
